...
const LookBookSection = () => {
  ...
  return (
    <div className="w-full min-h-[700px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 grid-rows-6">
      <div
        style={{
          backgroundImage: `linear-gradient(to bottom, #456d4533, rgba(0, 0, 0, 0.218)), url(${data?.docs[0]?.image?.url || '/images/trending1.jpg'})`
        }}
      ...
      <div
        style={{
          backgroundImage: `linear-gradient(to bottom, #456d4533, rgba(0, 0, 0, 0.218)), url(${data?.docs[1]?.image?.url || '/images/trending2.jpg'})`
        }}
      ...
      <div
        style={{
          backgroundImage: `linear-gradient(to bottom, #456d4533, rgba(0, 0, 0, 0.218)), url(${data?.docs[2]?.image?.url || '/images/trending3.jpg'})`
        }}
      ...
      <div
        style={{
          backgroundImage: `linear-gradient(to bottom, #456d4533, rgba(0, 0, 0, 0.218)), url(${data?.docs[3]?.image?.url || '/images/trending4.jpg'})`
        }}
      ...
      <div
        style={{
          backgroundImage: `linear-gradient(to bottom, #456d4533, rgba(0, 0, 0, 0.218)), url(${data?.docs[4]?.image?.url || '/images/trending5.jpg'})`
        }}
